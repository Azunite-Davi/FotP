...
# [end of flashback]
    ...
    "It was no wonder why the entire high echelon up until the king was only composed of lizards and dragons."
    ...
    "Slowly it dawned on him... {w}that muzzle belonged to a fox he knew quite well..."
    "Wait, Shelibuum!"
...
certainly not permitted to let this meeting happen!"
    ...
    "Covered from head to toe, her tail was also curled so as not to announce her presence. {w}Silence once again enveloped both of us." 
    "In a way, it was comforting seeing an old friend. She fumbled in the pockets of her attire, taking out a carved statuette with an odd base that refused to remain still."
    "The strange object seemed almost drawn to Nabisin. {w}It shook a little, though that could’ve been Shelibuum’s nervousness getting the best of her." 
    "The figurine had no imperfections, bumps, or signs of knife work, either."
    ...
    "Getting a sign is the first step towards his liberation. {w}Now, the hard part is still to come. He attempted to script how his trial may proceed in his mind."
    "Now that the heavy weight was swiftly lifted, the bed seemed to draw even closer to him. {w}His thoughts were all around the place." 
    "It gave himself another excuse to just lay down and forget everything."
    "The chilly night felt a bit warmer that day. {w}The fine, scented breeze reminded Nabisin of his time sleeping at the temple headquarters once he had been initiated as a priest."
    "He was required to live by older priests and his colleagues. {w}A certain someone always tried to bother him at every turn." 
    "Speaking up to the higher ones was of no avail, as they seemed to enjoy seeing acolytes being harsh to each other."
    "Sometimes it could be fun. {w}They used to play many silly games, but even when harsher forms of aggression took form, higher-ups still didn’t care."
    ...
    "Every day he followed the same routine, tiresome as it was. {w}He only had one thing to do: wake up and face the guards."
    ...
    "Each at their respective spots, the two guards shuffled places. {w}Nabisin assumed much was to come in the following hours."
    ...
    "A weird stinging sensation across his arms made them incredibly itchy for a moment. {w}His fur felt as if being torn apart by small flames, and his lower legs also felt worse than painful stings." 
    "Then, as if nothing had happened, relief overwhelmed him. {w}The winds settled on him, making it much easier to reassess the situation and check his arms and legs."
    "Unsurprisingly, nothing seemed etched into his fur, as the burning sensation would have indicated. {w}Not a single scratch or patch of fur had been damaged."
    ...
    "Neither Lulu nor Shelibuum were seen. They were either late or were not invited. {w}This seemed quite strange, given that they also partook in Nabisin’s “crime” so to speak."
...
# Guard:
    ...
    "Trying not to embarrass himself more, he rose from the ground and went back to his place. {w}He remembered when Shelibuum gave him the statuette and how, even though it had been less than a day, he had given the object emotional significance as a gift, hope, and love."
    ...
    "Remembering long lost memories that both reminded him of happier times of ignorance and the burning sensation that felt as if his skin was being torn apart, yet no signs of cuts. {w}Now add to the list his gift creating a mind of his own and attaching itself to the floor."
    "There was no explanation whatsoever. Being alone again was a mind-numbing experience. {w}He hadn’t been like this for years."
    "He was always by Luludân, and yet right now, he felt as if the world had become a husk of itself. {w}He barely knew what was to come."
    "Suddenly, the room grew wider and taller. {w}Nabisin, at the center, stood still when he saw another familiar muzzle—that of Shelibuum, calming his nerves. {w}At least she was smiling, but soon, she turned her gaze back to her doings."
# Judge:
...
# Nabisin:
    ...
    "No one other than Nabisin noticed the atmosphere around them mutating, manifesting some tempest or solar eclipse. {w}The statuette was too far away, just outside his range of vision to notice the small details. {w}But its silhouette was visible, and it changed its pose." 
...
# Utudug:
    show u at left:
        xzoom -1
    u "“Well, I know much about our infancy and time spent at the temples, cares, and I didn’t hold such grudges against you, Nabisin. {w}I remind you, our activities were weak, but you grew sour of me and my comrades. How can one speak up for you when you clearly can’t handle a playful shove?”"
    u "“Onto the next matter, your liking is evident; you are feminine. {w}Girl-like. {w}Your taste is vile and that of twisted nature. {w}That’s very much why the gods had passed down the laws we know and exercise on this land, which by your own narrative is being punished by divine intervention or lack thereof.”"
    u "“You are practically a female, Nabisin. {w}Accept it. {w}Dress like one of them; your slender physique reminds me of a slave I once had who married a mutt and managed to become free.\"" 
...
room goes silent."
    ...
    "The statuette struck another pose, and Nabisin already knew to follow. {w}Meanwhile, the judge tried to raise his voice once more, and Nabisin ignored him. Locked in a trance-like state, he danced at the statuette’s will as if nothing else mattered."
